...
FullFileUrl = "http://www.google.com/events.json" #path_for_storage_location/event.json
...
class UpdateHandler(webapp.RequestHandler):
    def get(self):
        try:
            _file = urllib.urlretrieve('http://events.hackerdojo.com/events.json', FullFileUrl)
        except:
